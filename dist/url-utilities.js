(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'koco-configs', 'koco-array-utilities', 'koco-string-utilities', 'koco-query', 'jquery', 'koco'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('koco-configs'), require('koco-array-utilities'), require('koco-string-utilities'), require('koco-query'), require('jquery'), require('koco'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.kocoConfigs, global.kocoArrayUtilities, global.kocoStringUtilities, global.kocoQuery, global.jquery, global.koco);
    global.urlUtilities = mod.exports;
  }
})(this, function (exports, _kocoConfigs, _kocoArrayUtilities, _kocoStringUtilities, _kocoQuery, _jquery, _koco) {
  'use strict';
  ...
  UrlUtilities.prototype.getReturnUrl = function (_default) {
    ...
    var context = _koco2.default.router.viewModel();
  ...
  UrlUtilities.prototype.appendParams = function (url, data, traditionalParam) {
    if (!_jquery2.default.isEmptyObject(data)) {
      return '' + url + (url.indexOf('?') >= 0 ? '&' : '?') + _jquery2.default.param(data, !!traditionalParam);
    }
